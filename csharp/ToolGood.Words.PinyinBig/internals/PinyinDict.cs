...
namespace ToolGood.Words.PinyinBig.internals
{
            ...
            if (_search == null) {
                lock (lockObj) {
                    if (_search == null) {
                        ...
                        Stream sm = ass.GetManifestResourceStream("ToolGood.Words.PinyinBig.dict.PinyinDict.dat");
                        ...
                        Stream sm2 = ass.GetManifestResourceStream("ToolGood.Words.PinyinBig.dict.SearchEx.dat");
